...
public class CommandProcessor {
    ...
    public void processor(String line) {
        ...
        if (command.equals("insert")) {
            ...
            int parW = Integer.valueOf(arr[4]);
            int parH = Integer.valueOf(arr[5]);

            Rectangle rect = new Rectangle(parX, parY, parW, parH);
            KVPair<String, Rectangle> pair = new KVPair<>(parName, rect);
            data.insert(pair);
...
// number of white space delimited strings in the line
            ...
            if (numParam == 1) {
                ...
                data.remove(parX, parY, parW, parH);
